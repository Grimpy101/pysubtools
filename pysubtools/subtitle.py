...
class HumanTime(yaml.YAMLObject):
  ...
  def from_string(cls, time: str) -> 'HumanTime':
    ...
    if isinstance(time, str):
      ...
      obj.hours = int(time_split[0])
      obj.minutes = int(time_split[1])
      obj.seconds = float(time_split[2])
    else:
...
class Frame(yaml.YAMLObject):
  ...
  @classmethod
  def from_yaml(cls, loader: yaml.Loader, node: typing.Union[yaml.MappingNode, yaml.ScalarNode]) -> 'Frame':
    value = loader.construct_scalar(node)
...
class SubtitleLines(typing.List):
  ...
  def __new__(cls, subtitles: typing.List[typing.Union[SubtitleLine, str]] = []) -> 'SubtitleLines':
  ...
  def append(self, value: typing.Union[SubtitleLine, str]) -> None:
...
class SubtitleUnit:
  ...
  def __setitem__(self, index: int, value: SubtitleLine) -> None:
    self._lines[index] = value

  def __getitem__(self, index: int) -> SubtitleLine:
  ...
  @property
  def duration(self) -> typing.Union[float, Frame]:
  ...
  def __sub__(self, other: typing.Union[int, float]) -> 'SubtitleUnit':
  ...
  def __add__(self, other: typing.Union[int, float]) -> 'SubtitleUnit':
    """See SubtitleUnit.get_moved."""
    return self.get_moved(other)

  def __isub__(self, other: typing.Union[int, float]) -> None:
    """Same as SubtitleUnit.move."""
    if not isinstance(other, (int, float)):
      raise TypeError("Need type of int, long or float instead of '{}'".format(type(other)))
    self.move(-1 * other)

  def __iadd__(self, other: typing.Union[int, float]) -> None:
    """Same as SubtitleUnit.move"""
    self.move(other)

  def __mul__(self, other: typing.Union[int, float]) -> 'SubtitleUnit':
    """See SubtitleUnit.get_stretched."""
    return self.get_stretched(other)

  def __imul__(self, other: typing.Union[int, float]) -> None:
  ...
  def to_dict(self, human_time: bool = True) -> typing.Dict[str, typing.Any]:
  ...
  def from_dict(cls, input: typing.Any) -> 'SubtitleUnit':
    ...
    return cls(
      lines = SubtitleLines(subtitle_lines),
      **input
    )
...
class Subtitle:
  ...
  def __init__(self, units: typing.List[SubtitleUnit] = [], **meta) -> None:
  ...
  def append(self, unit: SubtitleUnit) -> None:
    """Proxy for internal storage."""
    if not isinstance(unit, SubtitleUnit):
      raise TypeError("Can add only SubtitleUnit, you passed '{}'".format(type(unit)))
  ...
  @classmethod
  def from_dict(cls, data: typing.Any) -> 'Subtitle':
  ...
  @classmethod
  def from_file(cls, input: typing.Any) -> typing.Optional['Subtitle']:
    """
  ...
  @classmethod
  def from_file_multi(cls, input: typing.Any) -> typing.Generator['Subtitle', typing.Any, None]:
  ...
  def dump(self, output: typing.Any = None, human_time: bool = True, allow_unicode: bool = True) -> typing.Optional[bytes]:
  ...
  def save(self, output: typing.Any, human_time: bool = True, close: bool = True, allow_unicode: bool = True):
    """
